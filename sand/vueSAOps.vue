<template>
  ...
  <div style="height:100vh" class="mr-3">
    ...
    <b-modal id="WOSandCompleteModal" ref="WOSandCompleteModal"
      @show="onShowWOQuality"
      @hide="onHideWOQuality($event)"
      static>
      ...
      <template #modal-footer="{ok, cancel}">
        ...
        <b-form ref="sandForm">
          ...
          <b-col>          
              <b-form-group label="Quantity Completed"
                            :label-for="'sandQty'"
                            label-size="sm"
                            class="modalfield">
                <b-form-input :id="'SandQty'" :state="validCaliper1"
                              size="sm"        
                              v-model="curSandQty.qaCaliper1"></b-form-input>
              </b-form-group>
            </b-col>  
          ...
          <b-row>      
            <b-col>
              <b-form-group label="Notes"
                            ...
                            label-size="sm"
                            class="mr-5">
                <b-form-textarea :id="'sandNotes'" debounce="300"
                                v-model="curShot.Notes" rows="3" max-rows="3"
                                width="100%"> 
                </b-form-textarea>                                                   
              </b-form-group>           
            ...
            <b-table-simple>
              <b-thead>
                <b-tr>
                  <b-th>Caliper 1</b-th>
                  <b-th>Caliper 2</b-th>
                  <b-th>Caliper Front</b-th>
                  <b-th>Caliper Back</b-th>                  
                  <b-th>Actual Weight</b-th>
                </b-tr>
              </b-thead>
              <b-tbody>
                <b-tr>
      ...
      data() {
        return {
              colsPress: [
                  ...
                  {title: '', field:"ActiveTable2", hozAlign:"center", headerSort:false, responsive:0,
          ...
          dataRefreshInterval: 90, //auto-refresh, in seconds
        ...
        decBusy: function() {
          ...
          if (thatVue.busyCount <= 0) {
            ...
            if (thatVue.dataRefreshInterval && !thatVue.dataRefreshTimer) {
              thatVue.dataRefreshTimer = setInterval(thatVue.fetchData, thatVue.dataRefreshInterval * 1000);
            }      
          }
        },      
  ...
  //        }
        ...
        completeShot: function(tableCode) {
            ...
            if (!thatVue.curWorkerQGUID) {
              ...
              thatVue.$bvModal.show('WOQualityModal');        
              thatVue.$bvModal.show('WOSandCompleteModal');        
