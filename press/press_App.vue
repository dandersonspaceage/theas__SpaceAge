    ...
    <b-row>
        ...
        <b-col cols="6">
          ...
          <b-row>
            ...
            <b-col>     
              <h6 style="font-size:calc(0.7em + 1.4vmin)">WO [[ data_ThisWOA.WONumber ]] (#[[ Number(data_ThisWOA.CurrentShotCount) + 1 ]] of [[ data_ThisWOA.Quantity]])</h6>
            </b-col>      
          </b-row>      
        ...
        <b-col cols="6">
          ...
          <b-row>
            ...
            <b-col>     
              <h6 style="font-size:calc(0.7em + 1.4vmin)">WO [[ data_ThisWOB.WONumber ]] (#[[ Number(data_ThisWOB.CurrentShotCount) + 1 ]] of [[ data_ThisWOB.Quantity]])</h6>
            </b-col>      
          </b-row>      
